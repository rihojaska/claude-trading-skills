...
def test_fmp_decimal_roe_and_margin_are_converted_to_percent(monkeypatch):
    ...
    # This screener has no bare FMP stock-screener path (unavailable on the
    # free tier) — candidates enter via the local-universe path instead.
    ...
    result = mod.screen_dividend_growth_pullbacks("test-key", universe_symbols=["TEST"])[0]
